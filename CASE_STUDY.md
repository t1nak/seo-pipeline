...
Der folgende Text ist eine ausführlichere Version des [README](README.md) auf Deutsch.
...
- Cluster 4 (aktuell „Lohnabrechnung und Bewerberverwaltung") ist heterogen — enthält `aüg`, `bewerber finden`, `lohnabrechnung sage`, `indeed alternative`. Kein klares Pillar-Thema. Empfohlene Bearbeitung: Top-Keywords einzeln, nicht als Pillar.
- Cluster 12 (aktuell „Zeitarbeit Branche Software und Tools") ist mit 97 Keywords der größte Cluster. Bündelt „Zeitarbeit + X" Kombinationen aus Software, Factoring, CRM, Lohn. Empfohlen: Sub-Clustering vor Bearbeitung. Vollständige pro-Cluster-Empfehlung in [`docs/results.md`](docs/results.md).
