...
CLUSTER_LABELS_EN = {
    ...
    1: "Recruiting & AI tooling",
    2: "Commercial SaaS heads (Zeit/Software)",
    3: "Mixed operational how-to",
    4: "Brand: zvoove product names",
    5: "Mid-funnel HR ops",
    6: "Equal pay & cashflow risk",
    7: "Tariff & überlassung law (info)",
    8: "Digitalisation umbrella",
    9: "Gebäudereinigung vertical",
    10: "B2B SaaS category heads",
    11: "AÜG / labor-law pillar (info)",
    12: "Industry & operations catch-all",
}

CLUSTER_LABELS_DE = {
    -1: "Rauschen / Ausreißer",
    0: "Factoring-Grundlagen",
    1: "Recruiting & KI-Tools",
    2: "Kommerzielle SaaS-Heads (Zeit/Software)",
    3: "Operative Anleitungen (gemischt)",
    4: "Marke: zvoove Produktnamen",
    5: "HR-Mid-Funnel",
    6: "Equal Pay & Cashflow-Risiko",
    7: "Tarif- & Überlassungsrecht (info)",
    8: "Digitalisierung allgemein",
    9: "Gebäudereinigung-Vertikale",
    10: "B2B-SaaS Kategorie-Heads",
    11: "AÜG / Arbeitsrecht-Pillar (info)",
    12: "Branche & Betrieb (Sammelbecken)",
}
